...
public class HllSketchMergeAggregatorTest {
    ...
    public void testAllFields() throws JacksonException, JSONException {
        ...
        HllSketchMergeAggregator hllSketchMergeAggregator =
                HllSketchMergeAggregator.builder()
                        .name("stars_hll")
                        .fieldName("stars")
                        .lgK(4)
    ...
    public void testRequiredFields() throws JacksonException, JSONException {
        ...
        HllSketchMergeAggregator hllSketchMergeAggregator =
                HllSketchMergeAggregator.builder().name("stars_hll").fieldName("stars").build();
    ...
    public void testNullName() {
        ...
        HllSketchMergeAggregator hllSketchMergeAggregator =
                HllSketchMergeAggregator.builder().fieldName("stars").build();
    }
    ...
    public void testNullFieldName() {
        ...
        HllSketchMergeAggregator hllSketchMergeAggregator =
                HllSketchMergeAggregator.builder().name("stars_hll").build();
    }
}
