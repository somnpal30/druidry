...
public class TupleSketchToQuantilesSketchPostAggregator extends DruidPostAggregator {
    ...
    private static final String TUPLE_SKETCH_TO_QUANTILES_SKETCH_AGGREGATOR_TYPE =
    ...
    @Builder
    private TupleSketchToQuantilesSketchPostAggregator(
            @NonNull String name, @NonNull DruidPostAggregator field, Integer column, Integer k) {
